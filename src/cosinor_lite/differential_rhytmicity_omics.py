...
MODELS_ONE_CONDITION: tuple[BaseModelOneCondition, ...] = (M1OneCondition(), MOscOneCondition())
...
class DifferentialRhythmicity:
    ...
    def rhythmic_genes_expressed_both(self) -> pd.DataFrame:
    ...
    def extract_all_circadian_params(self) -> pd.DataFrame:
        ...
        results_total = pd.concat([rhythmic_analysis_expressed_both, rhythmic_analysis_cond1, rhythmic_analysis_cond2])
